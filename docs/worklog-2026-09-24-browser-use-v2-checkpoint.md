...
- Internal Chromium host, partition, renderer and IPC were not modified by these Browser Use
  slices. A fresh Windows x64 installer was generated from this reviewed source checkpoint.
