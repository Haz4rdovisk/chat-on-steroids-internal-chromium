...
- The full `npm run verify` was not repeated here; the paired Mainstream run
  encountered four unrelated under-load failures, all 310/310 tests in the
  affected files passing in isolation. Internal validation covers the changed
  boundaries, build and built Electron flow.
